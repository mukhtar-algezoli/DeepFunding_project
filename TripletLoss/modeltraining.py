    ...
    wandb.config.update(
        {
            ...
            'data_path': data_path,
            'device': device,
            'LoRa_Rank': peft_config.r if peft_config is not None else None,
            'LoRa_Alpha': peft_config.lora_alpha if peft_config is not None else None,
            'LoRa_Dropout': peft_config.lora_dropout if peft_config is not None else None,
            'LoRa_Target_Modules': peft_config.target_modules if peft_config is not None else None,
